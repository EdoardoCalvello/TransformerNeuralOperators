import sys
sys.path.append('../../')
from models.ViTNO.runner import Runner
from utils import dict_combiner
import argparse

# use argparse to get command line argument for which experiment to run
parser = argparse.ArgumentParser()
parser.add_argument('--project_name', type=str, default='2d_paper_experiments_ViTNO')
...
exp_dict = {
    ...
    'test_patch_sizes': [[64,32,16]],
    'batch_size': [2],
    'dyn_sys_name': ['darcy_low_res'], #'darcy_high_res','darcy_discontinuous',
    # optimizer settings
    'learning_rate': [1e-4],
    'dropout': [1e-4],
    'lr_scheduler_params': [
