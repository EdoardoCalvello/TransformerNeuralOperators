...
checkpoint_path = '../../run_scripts/basic_darcy_debug/lightning_logs/i6yf9zw3/checkpoints/epoch=79-step=128000.ckpt'
...
api = wandb.Api()
run = api.run('edoardo-calvello/papeer_experiments/i6yf9zw3')
