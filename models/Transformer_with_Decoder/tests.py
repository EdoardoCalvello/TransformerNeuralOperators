...
from Transformer import TransformerEncBlock
...
class ViT_TransformerEnc_block_tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.input_dim = 12
        cls.num_heads = 3
        ...
        # transformer block
        tb = TransformerEncBlock(cls.input_dim, cls.num_heads, cls.mlp_dim, dropout=cls.dropout)
